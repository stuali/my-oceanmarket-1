...
- A server for hosting GeneVaultplace.
- Obtain API key for wanted network.

### Push your customized GeneVault code to your Git repository

In case you customized the GeneVault using the tutorial from this chapter (link), push your code to a Git repository.
...
In the following Dockerfile, replace \<YOUR_GIT_REPO_URL> with the url of your GeneVault fork repository or use "https://github.com/oceanprotocol/market.git" if you want to deploy the standard image of GeneVault.
